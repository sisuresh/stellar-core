...
CreateClaimableBalanceOpFrame::doApply(AbstractLedgerTxn& ltx)
{
    ...
    // TODO siddharth: low reserve check is now after underfunded. Is that
    // alright?
    switch (createEntryWithSponsoringAcc(ltx, header, newClaimableBalance,
                                         sourceAccount))
    {
    ...
    case SponsorshipResult::TOO_MANY_SUBENTRIES:
        // TODO siddharth: This is impossible because claimable balances don't
        // use subentries... should we fall through and throw instead?
