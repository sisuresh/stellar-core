...
class OperationMetaBuilder
{
  public:
    ...
    void setLedgerChanges(LedgerEntryChanges const& initialChanges, stellar::UnorderedMap<stellar::LedgerKey, stellar::LedgerEntry> const& hotArchiveRestores,stellar::UnorderedMap<stellar::LedgerKey, stellar::LedgerEntry> const& liveRestores, uint32_t ledgerSeq);
