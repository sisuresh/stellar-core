...
TEST_CASE("contract storage", "[tx][soroban]")
{
    ...
    auto put = [&](std::string const& key, uint64_t val, ContractDataDurability type,
    ...
    SECTION("Enforce rent minimums")
    {
        ...
        checkContractDataExpiration("unique", ContractDataDurability::PERSISTENT,
    ...
    SECTION("autobump")
    {
        ...
        checkContractDataExpiration("ro", ContractDataDurability::PERSISTENT,
                                    expectedInitialExpiration + autoBump);
        checkContractDataExpiration("nobump", ContractDataDurability::PERSISTENT,
...
TEST_CASE("Stellar asset contract XLM transfer", "[tx][soroban]")
{
    ...
    metadataKey.contractData().type = ContractDataDurability::PERSISTENT;
    ...
    assetInfoLedgerKey.contractData().type = ContractDataDurability::PERSISTENT;
    ...
    contractExecutableKey.contractData().type = ContractDataDurability::PERSISTENT;
    ...
    balanceLedgerKey.contractData().type = ContractDataDurability::PERSISTENT;
