...
class OpEventManager
{
  ...
  public:
    ...
    void eventsForClaimAtoms(MuxedAccount const& source,
    ...
    // TODO: Maybe make the transfer, mint, and burn methods private if
    // possible?
    ...
    void newTransferEvent(Asset const& asset, SCAddress const& from,
                          SCAddress const& to, int64 amount, Memo const& memo);
