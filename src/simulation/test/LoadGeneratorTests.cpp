...
TEST_CASE("apply only load", "[loadgen][applyload]")
{
    ...
    cfg.LOADGEN_NUM_DATA_ENTRIES_FOR_TESTING = {30};
    cfg.LOADGEN_NUM_DATA_ENTRIES_DISTRIBUTION_FOR_TESTING = {1};
    cfg.LOADGEN_IO_KILOBYTES_FOR_TESTING = {1};
    cfg.LOADGEN_IO_KILOBYTES_DISTRIBUTION_FOR_TESTING = {1};
    cfg.LOADGEN_TX_SIZE_BYTES_FOR_TESTING = {1};
    cfg.LOADGEN_TX_SIZE_BYTES_DISTRIBUTION_FOR_TESTING = {2};
    cfg.LOADGEN_INSTRUCTIONS_FOR_TESTING = {50'000'000};
    cfg.LOADGEN_INSTRUCTIONS_DISTRIBUTION_FOR_TESTING = {1};
